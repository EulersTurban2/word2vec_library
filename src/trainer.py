...
from preprocessing import get_training_batches, preprocess_list


def train_step(model:SkipGram_Model|CBOW_Model, target_idx, context_idx, negative_indices, lr: float = 0.01):
...
def train_and_validate(tokens, word2idx, model:SkipGram_Model|CBOW_Model, num_epochs = 5, window_size = 2,  n_samples = 5, lr=0.01, train_test_split:float = 0.8):
